...
class ClubSettingsModel(Base):
    ...
    payment_details: Mapped[str] = mapped_column(Text, default="Реквизиты не указано")
    ...
    fee_assessment_day: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
